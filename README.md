# Anabelian Hyperbolicity — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/anabelian-hyperbolicity-canonical-lane-mathlib.git
cd anabelian-hyperbolicity-canonical-lane-mathlib
lake exe
lake build
```
